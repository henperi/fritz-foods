...
import { AboutSection, AboutCard } from "../ui/AboutCard";
    ...
    <div>
      ...
      <main>
        ...
        <div className="p-h-5 text-center">
          <p>
            To enjoy amazing discounts and have a fun filled experience, login
            to your account!
          </p>
          <div>
        ...
        <div className="containerX">
          ...
          <section>
            <div className="card text-center">
              ...
              <p>
                <a
                  href="users/foods.html"
                  className="btn btn-blue btn-rounded btn-bg"
                >
                  View Menu
                </a>
              </p>
